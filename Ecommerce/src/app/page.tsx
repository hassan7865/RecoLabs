...
export const newArrivalsData: Product[] = [
  ...
  {
    id: 4,
    title: "3D Geometry Puzzle Builder",
    srcUrl: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400&h=400&fit=crop",
    gallery: ["https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1558618666-fbd6c327c926?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1632769432440-82e88180cd4b?w=400&h=400&fit=crop"],
    price: 34,
    discount: {
      amount: 0,
      percentage: 20,
    ...
    stemCategory: "Math",
    educationalLevel: "Beginner",
    learningObjectives: ["Spatial reasoning", "Geometric shapes", "Pattern recognition"],
    keySkills: ["Visual-spatial skills", "Logic", "Problem solving"],
    reviewCount: 203,
    educationalValue: "Visual math learning"
  },
];
...
export const topSellingData: Product[] = [
  ...
  {
    id: 6,
    title: "Microscope Discovery Set",
    srcUrl: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop",
    gallery: ["https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1576319155264-99536e0be1ee?w=400&h=400&fit=crop"],
    price: 95,
    discount: {
      amount: 0,
      percentage: 0,
    ...
    stemCategory: "Science",
    educationalLevel: "Beginner",
    learningObjectives: ["Microscopy", "Cell biology", "Scientific observation"],
    keySkills: ["Observation", "Scientific method", "Data recording"],
    reviewCount: 189,
    educationalValue: "Explore the microscopic world"
  },
  {
    id: 7,
